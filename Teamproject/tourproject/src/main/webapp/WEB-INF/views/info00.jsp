			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
					...
					<li class="nav-item"><a class="nav-link active"
						aria-current="page"> ${result0.location } </a></li>
					<li class="nav-item">
	...
	<header class="py-1 bg-light border-bottom mb-4">
		<div class="container">
			<div class="text-center my-5">
				<h1 class="fw-bolder">${result0.location }</h1>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-8-info">
				<!-- Featured blog post-->
				<div class="card mb-4">
					<a href="http://www.royalpalace.go.kr/"><img
						class="card-img-top"
						src=http://www.royalpalace.go.kr/content/images/data/data_03_01_15.jpg
						alt="..." /></a>
					<div class="card-body">
						<div class="small text-muted">${result0.region }</div>
						<h2 class="card-title">${result0.location }&nbsp;&nbsp;&nbsp;&nbsp;
							<script
						...
						<p class="card-text">
							...
							<!-- index 0번 -->
							요금 : ${result0.price }<br> 운영시간 : ${result0.opentime }<br>
							<br> ${result0.info }<br> <br> <a
								class="btn btn-primary" href="http://www.royalpalace.go.kr/">공식
								사이트</a>
					</div>
				</div>
			</div>
		...
		<script>
				var mapContainer = document.getElementById('map'),
				    mapOption = { 
				        center: new kakao.maps.LatLng(37.577541204733755, 126.97687751337057), // 지도의 중심좌표
				        level: 4 // 지도의 확대 레벨
				    };
