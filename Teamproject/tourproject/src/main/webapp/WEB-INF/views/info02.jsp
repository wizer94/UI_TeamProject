			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
					...
					<li class="nav-item"><a class="nav-link active"
						aria-current="page"> ${result2.location } </a></li>
	...
	<header class="py-1 bg-light border-bottom mb-4">
		<div class="container">
			<div class="text-center my-5">
				<h1 class="fw-bolder">${result2.location }</h1>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-8-info">
				...
				<!-- Featured blog post-->
				<div class="card mb-4">
					<a href="https://hanok.seoul.go.kr/front/index.do"><img
						class="card-img-top"
						src=https://hanok.seoul.go.kr/images/sub/town_intro1_1.jpg
						alt="..." /></a>
					<div class="card-body">
						<div class="small text-muted">${result2.region }</div>
						<h2 class="card-title">${result2.location }&nbsp;&nbsp;&nbsp;&nbsp;
							<script
						...
						<p class="card-text">
							...
							<!-- index 2번 -->
							요금 : ${result2.price }<br> 운영시간 : ${result2.opentime }<br>
							<br> ${result2.info }<br> <br>
		...
		<script>
				var mapContainer = document.getElementById('map'),
				    mapOption = { 
				        center: new kakao.maps.LatLng(37.58309015362402, 126.98327245549055), // 지도의 중심좌표
				        level: 2 // 지도의 확대 레벨
				    };
