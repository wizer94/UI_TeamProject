  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
          ...
          <li class="nav-item"><a class="nav-link" href="/">Main</a></li>
						...
						<li class="nav-item"><a class="nav-link active"
							aria-current="page"> ${result5.location } </a></li>
						<li class="nav-item">
         ...
         <header class="py-1 bg-light border-bottom mb-4">
            <div class="container">
                <div class="text-center my-5">
                    <h1 class="fw-bolder">${result5.location }</h1>
         ...
         <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8-info"> <!-- css 에 1400줄 복사하여 추가 생성 -->
                    <!-- Featured blog post-->
                    <div class="card mb-4">
                        <a href="https://www.lwt.co.kr/ko/main/main.do"><img class="card-img-top" 
                        src=https://ldb-phinf.pstatic.net/20180821_197/1534835312642oACAL_JPEG/btDf0E8sAW2BF1p-5EYZ6msv.jpg alt="..." /></a>
                        <div class="card-body">
                            <div class="small text-muted">${result5.region }</div>
                            <h2 class="card-title">${result5.location }&nbsp;&nbsp;&nbsp;&nbsp;
							<script
						...
						Kakao.Share.createCustomButton({
                            ...
                            <a class="btn btn-primary" href="https://www.lwt.co.kr/ko/main/main.do">공식 사이트</a>
                        </div>
                    </div>
                 </div> 
 			 </div>
 			 <!-- 지도영역 -->
				...
				var mapContainer = document.getElementById('map'),
				    mapOption = { 
				        center: new kakao.maps.LatLng(37.51266079598733 , 127.10255000820834 ), // 지도의 중심좌표
				        level: 2 // 지도의 확대 레벨
				    };
