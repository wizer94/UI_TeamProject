  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
       ...
       <li class="nav-item"><a class="nav-link" href="/">Main</a></li>
						...
						<li class="nav-item"><a class="nav-link active"
							aria-current="page"> ${result8.location } </a></li>
						<li class="nav-item">
         ...
         <header class="py-1 bg-light border-bottom mb-4">
            <div class="container">
                <div class="text-center my-5">
                    <h1 class="fw-bolder">${result8.location }</h1>
         ...
         <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8-info"> <!-- css 에 1400줄 복사하여 추가 생성 -->
                    <!-- Featured blog post-->
                    <div class="card mb-4">
                        <a href="https://seoulforest.or.kr/"><img class="card-img-top" 
                        src=https://ldb-phinf.pstatic.net/20200728_296/1595899415265D5A3d_JPEG/%B0%A1%C1%B7%B8%B6%B4%E71.jpg alt="..." /></a>
                        <div class="card-body">
                            <div class="small text-muted">${result8.region }</div>
                            <h2 class="card-title">${result8.location }&nbsp;&nbsp;&nbsp;&nbsp;
							<script
						...
						Kakao.Share.createCustomButton({
                            ...
                            <a class="btn btn-primary" href="https://seoulforest.or.kr/">공식 사이트</a>
                        </div>
                    </div>
                 </div> 
 			 </div>
 			 <!-- 지도영역 -->
				...
				var mapContainer = document.getElementById('map'),
				    mapOption = { 
				        center: new kakao.maps.LatLng(37.544628542427226 , 127.03770391239568 ), // 지도의 중심좌표
				        level: 3 // 지도의 확대 레벨
				    };
