            ...
            <div class="container">
             ...
             <li class="nav-item"><a class="nav-link" href="/">Main</a></li>
						...
						<li class="nav-item"><a class="nav-link active"
							aria-current="page"> ${result9.location } </a></li>
						<li class="nav-item">
         ...
         <header class="py-1 bg-light border-bottom mb-4">
            <div class="container">
                <div class="text-center my-5">
                    <h1 class="fw-bolder">${result9.location }</h1>
         ...
         <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8-info"> <!-- css 에 1400줄 복사하여 추가 생성 -->
                    <!-- Featured blog post-->
                    <div class="card mb-4">
                        <a href="https://www.museum.go.kr/site/main/home"><img class="card-img-top" 
                        src=https://ldb-phinf.pstatic.net/20140407_294/1396854286084f1Igq_JPEG/%BC%AD%BF%EF_%B1%B9%B8%B3%C1%DF%BE%D3%B9%DA%B9%B0%B0%FC_14.jpg?type=m500_500 alt="..." /></a>
                        <div class="card-body">
                            <div class="small text-muted">${result9.region }</div>
                            <h2 class="card-title">${result9.location }&nbsp;&nbsp;&nbsp;&nbsp;
							<script
						...
						Kakao.Share.createCustomButton({
                            ...
                            <a class="btn btn-primary" href="https://www.museum.go.kr/site/main/home">공식 사이트</a>
                        </div>
                    </div>
                 </div> 
 			 </div>
 			 <!-- 지도영역 -->
				...
				var mapContainer = document.getElementById('map'),
				    mapOption = { 
				        center: new kakao.maps.LatLng(37.523873861084006 , 126.98031613736792 ), // 지도의 중심좌표
				        level: 4 // 지도의 확대 레벨
				    };
