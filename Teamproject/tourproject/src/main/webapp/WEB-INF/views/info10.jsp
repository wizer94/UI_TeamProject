			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
					...
					<li class="nav-item"><a class="nav-link active"
						aria-current="page"> ${result10.location } </a></li>
					<li class="nav-item"><a class="nav-link" href="#!"
						onclick="alert('추후 업데이트 예정입니다.')">Q&A</a></li>
				</ul>
			</div>
		</div>
		<!-- Google 번역 -->
	...
	<header class="py-1 bg-light border-bottom mb-4">
		<div class="container">
			<div class="text-center my-5">
				<h1 class="fw-bolder">${result10.location }</h1>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-8-info">
				<!-- css 에 1400줄 복사하여 추가 생성 -->
				<!-- Featured blog post-->
				<div class="card mb-4">
					<a href="https://www.seoultower.co.kr/"><img
						class="card-img-top"
						src=https://imgstower.ytn.co.kr/gallery/2020/202002061001382252.jpg
						alt="..." /></a>
					<div class="card-body">
						<div class="small text-muted">${result10.region }</div>
						<h2 class="card-title">${result10.location }&nbsp;&nbsp;&nbsp;&nbsp;
							<script
						...
						<p class="card-text">
							<!-- index 10번 -->
							요금 : ${result10.price }<br> 운영시간 : ${result10.opentime }<br>
							<br> ${result10.info }<br> <br>
						</p>
						<a class="btn btn-primary" href="https://www.seoultower.co.kr/">공식
							사이트</a>
					</div>
				</div>
			</div>
		...
		<script type="text/javascript"
			src="//dapi.kakao.com/v2/maps/sdk.js?appkey=43f27a012c4843c87231e34c40221b00"></script>
		<div id="map" style="width: 100%; height: 350px;"></div>
		<script>
				var mapContainer = document.getElementById('map'),
				    mapOption = { 
				        center: new kakao.maps.LatLng(37.54849048351784 , 126.99085644254379 ), // 지도의 중심좌표
				        level: 4 // 지도의 확대 레벨
				    };
