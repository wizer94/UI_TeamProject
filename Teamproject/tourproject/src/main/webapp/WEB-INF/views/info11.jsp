  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <li class="nav-item"><a class="nav-link" href="/">Main</a></li>
						...
						<li class="nav-item"><a class="nav-link active"
							aria-current="page"> ${result11.location } </a></li>
						<li class="nav-item">
         ...
         <header class="py-1 bg-light border-bottom mb-4">
            <div class="container">
                <div class="text-center my-5">
                    <h1 class="fw-bolder">${result11.location }</h1>
         ...
         <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8-info"> <!-- css 에 1400줄 복사하여 추가 생성 -->
                    <!-- Featured blog post-->
                    <div class="card mb-4">
                        <a href="https://hangang.seoul.go.kr/archives/46758"><img class="card-img-top" 
                        src=https://ldb-phinf.pstatic.net/20140407_270/1396856320769yCwOM_JPEG/%BC%AD%BF%EF_%C7%D1%B0%AD%BD%C3%B9%CE%B0%F8%BF%F8%BF%A9%C0%C7%B5%B5%C1%F6%B1%B8_11.JPG?type=m500_500 alt="..." /></a>
                        <div class="card-body">
                            <div class="small text-muted">${result11.region }</div>
                            <h2 class="card-title">${result11.location }&nbsp;&nbsp;&nbsp;&nbsp;
							<script
						...
						Kakao.Share.createCustomButton({
                            ...
                            <p class="card-text">
								<!-- index 11번 -->
                                요금 : ${result11.price }<br>
								운영시간 : ${result11.opentime }<br>
								<br>
								${result11.info }<br>
								<br>
								</p>							
                            <a class="btn btn-primary" href="https://hangang.seoul.go.kr/archives/46758">공식 사이트</a>
                        </div>
                    </div>
                 </div> 
 			 </div>
 			 <!-- 지도영역 -->
				...
				var mapContainer = document.getElementById('map'),
				    mapOption = { 
				        center: new kakao.maps.LatLng(37.52630838833407 , 126.9350863974646 ), // 지도의 중심좌표
				        level: 4 // 지도의 확대 레벨
				    };
