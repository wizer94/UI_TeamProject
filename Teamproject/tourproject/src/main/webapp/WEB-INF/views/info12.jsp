  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
       ...
       <li class="nav-item"><a class="nav-link" href="/">Main</a></li>
						...
						<li class="nav-item"><a class="nav-link active"
							aria-current="page"> ${result12.location } </a></li>
						<li class="nav-item">
         ...
         <header class="py-1 bg-light border-bottom mb-4">
            <div class="container">
                <div class="text-center my-5">
                    <h1 class="fw-bolder">${result12.location }</h1>
         ...
         <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8-info"> <!-- css 에 1400줄 복사하여 추가 생성 -->
                    <!-- Featured blog post-->
                    <div class="card mb-4">
                        <a href="https://www.63art.co.kr/home/63ART/main.do"><img class="card-img-top" 
                        src=https://ldb-phinf.pstatic.net/20140407_153/13968556855735rGcX_JPEG/%BC%AD%BF%EF_63%BE%BE%C6%BC_1.jpg?type=m500_500 alt="..." /></a>
                        <div class="card-body">
                            <div class="small text-muted">${result12.region }</div>
                            <h2 class="card-title">${result12.location }&nbsp;&nbsp;&nbsp;&nbsp;
							<script
						...
						Kakao.Share.createCustomButton({
                            ...
                            <p class="card-text">
								<!-- index 12번 -->
                                요금 : ${result12.price }<br>
								운영시간 : ${result12.opentime }<br>
								<br>
								${result12.info }<br>
								<br>
								</p>							
                            <a class="btn btn-primary" href="https://www.63art.co.kr/home/63ART/main.do">공식 사이트</a>
                        </div>
                    </div>
                 </div> 
 			 </div>
 			 <!-- 지도영역 -->
				...
				var mapContainer = document.getElementById('map'),
				    mapOption = { 
				        center: new kakao.maps.LatLng(37.519914001856584 , 126.94026150542679 ), // 지도의 중심좌표
				        level: 4 // 지도의 확대 레벨
				    };
