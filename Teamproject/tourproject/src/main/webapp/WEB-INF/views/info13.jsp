         ...
         <header class="py-1 bg-light border-bottom mb-4">
            <div class="container">
                <div class="text-center my-5">
                    <h1 class="fw-bolder">${result13.location }</h1>
         ...
         <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8-info"> <!-- css 에 1400줄 복사하여 추가 생성 -->
                    <!-- Featured blog post-->
                    <div class="card mb-4">
                        <a href="https://ddp.or.kr/?menuno=228"><img class="card-img-top" 
                        src=https://ldb-phinf.pstatic.net/20170526_171/1495772011947hzUIv_JPEG/DDP1_%281%29.jpg alt="..." /></a>
                        <div class="card-body">
                            <div class="small text-muted">${result13.region }</div>
                            <h2 class="card-title">${result13.location }&nbsp;&nbsp;&nbsp;&nbsp;
							<script
						...
						Kakao.Share.createCustomButton({
                            ...
                            <p class="card-text">
								<!-- index 13번 -->
                                요금 : ${result13.price }<br>
								운영시간 : ${result13.opentime }<br>
								<br>
								${result13.info }<br>
								<br>
								</p>							
                            <a class="btn btn-primary" href="https://ddp.or.kr/?menuno=228">공식 사이트</a>
                        </div>
                    </div>
                 </div> 
 			 </div>
 			 <!-- 지도영역 -->
				...
				var mapContainer = document.getElementById('map'),
				    mapOption = { 
				        center: new kakao.maps.LatLng(37.56724009595421 , 127.0108097594182), // 지도의 중심좌표
				        level: 4 // 지도의 확대 레벨
				    };
